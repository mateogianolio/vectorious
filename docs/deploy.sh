...
parse_args() {
	...
	deploy_directory=${GIT_DEPLOY_DIR:-docs/_build}
	deploy_branch=${GIT_DEPLOY_BRANCH:-gh-pages}

	#if no user identity is already set in the current git environment, use this:
	default_username=${GIT_DEPLOY_USERNAME:-mateogianolio}
	default_email=${GIT_DEPLOY_EMAIL:-mateogianolio@users.noreply.github.com}
